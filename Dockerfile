...
LABEL maintainer="Altonhe" \
    ...
    org.label-schema.url="https://github.com/Altonhe/aria2-ariang-docker" \
    org.label-schema.license="MIT" \
    org.label-schema.vcs-ref=$VCS_REF \
    org.label-schema.vcs-url="https://github.com/Altonhe/aria2-ariang-docker" \
    org.label-schema.vcs-type="Git" \
    org.label-schema.vendor="altonhe" \
    org.label-schema.schema-version="1.0"

RUN apk add --no-cache caddy aria2 su-exec curl
